...
def fetch_waybill_data(wid: int = None) -> list or dict:
    ...
    """
    from server.extensions import db, WaybillLog, WeightLog
...
def fetch_customer_data(cid: int = None) -> list or dict:
    ...
    """
    from server.extensions import db, Customer
...
def fetch_haulier_data(hid: int = None) -> list or dict:
    ...
    """
    from server.extensions import db, Haulier
...
def fetch_user_data(user_id: int = None) -> list or dict:
    ...
    """
    from server.extensions import db, User
...
def fetch_weight_records(weight_log_id=None):
    from server.extensions import db, WeightLog, Haulier, WaybillLog
...
def fetch_table_data(weight_log_id):
    ...
    from server.extensions import db, WeightLog, Haulier, WaybillLog
    from server.helpers import myfunctions as func
