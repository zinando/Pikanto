...
class MyFrame(ctk.CTkFrame):
    ...
    def create_button(self, **kwargs):
        ...
        save_button = MyButton(self, text=text, command=command, font_size=font_size, font_weight=font_weight,
                               text_color=text_color, bg_color=bg_color, fg_color=fg_color, height=height,
                               width=width).create_obj()
        save_button.place(x=x, y=y)

        save_button.position_x = x
        save_button.position_y = y
    ...
    def create_label(self, **kwargs):
        ...
        lab = MyLabel(self, text=text, text_color=text_color, fg_color=fg_color, image=image, bg_color=bg_color,
                      height=height, width=width).create_obj()
        lab.place(x=x, y=y)
